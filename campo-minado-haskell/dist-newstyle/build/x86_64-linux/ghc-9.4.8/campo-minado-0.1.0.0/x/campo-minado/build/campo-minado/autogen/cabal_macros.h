...
/* package campo-minado-0.1.0.0 */
#ifndef VERSION_campo_minado
#define VERSION_campo_minado "0.1.0.0"
#endif /* VERSION_campo_minado */
#ifndef MIN_VERSION_campo_minado
#define MIN_VERSION_campo_minado(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_campo_minado */
...
#define CURRENT_COMPONENT_ID "campo-minado-0.1.0.0-inplace-campo-minado"
